...
fun CustomTextButton(
    ...
    Button(
        ...
        border = if (borderColor != Color.Transparent) BorderStroke(ContentInsetOne, borderColor) else null,
        ...
        CustomText(
            ...
            maxLines = 1,
            fontSize = fontSize,
            color = if (enabledButton) textColor else MaterialTheme.colorScheme.onSurface.copy(alpha = 0.38f)
        )
    }
}
